...
var DailyPlanSettingTab = class extends import_obsidian.PluginSettingTab {
  plugin;
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Daily Plan").setDesc("Settings for the Daily Plan plugin will appear here.").addButton(
...
var DailyPlanPlugin = class extends import_obsidian3.Plugin {
